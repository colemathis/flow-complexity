...
\centering
{\LARGE Time series for limit cases}\vspace{1em}\\
  \begin{overpic}[width=0.49\textwidth]{figures/results/A02/21-single-timeseries_1}
    \put(80,110){\huge }
    \put(-5,95){\textbf{(A)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A02/21-single-timeseries_33}
    \put(-5,95){\textbf{(B)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A02/21-single-timeseries_66}
    \put(-5,95){\textbf{(C)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A02/21-single-timeseries_100}
    \put(-5,95){\textbf{(D)}}
  \end{overpic}
\end{minipage}
\begin{minipage}{0.49\linewidth}	
\centering
{\Large Power law fits over inflow/outflow}\vspace{1em}\\
  \begin{overpic}[width=0.99\textwidth]{figures/results/A02/24-multipanel-pdf-inflow-outflow}
  	\put(-0,95){\textbf{(E)}}
  \end{overpic}
\end{minipage}

  \vskip1em
  {\LARGE Exponents of power law fits + avg. integer + mass}\vspace{1em}\\
  \begin{overpic}[width=0.32\textwidth]{figures/results/A02/24b-plot-pdf-inflow-outflow-exponent}
  	\put(-5,85){\textbf{(F)}}
  \end{overpic}
  \begin{overpic}[width=0.32\textwidth]{figures/results/A02/22-plot-avg-integer}
  	\put(-5,85){\textbf{(G)}}
  \end{overpic}
  \begin{overpic}[width=0.32\textwidth]{figures/results/A02/23-plot-total-mass}
  	\put(-5,85){\textbf{(H)}}
  \end{overpic}
  \caption{Key outputs: limit cases, power law fits and exponents, average integer and total mass.}
  \label{fig:wrap-up-15-18}
...
\centering
{\LARGE Time series for limit cases}\vspace{1em}\\
  \begin{overpic}[width=0.49\textwidth]{figures/results/A03/21-single-timeseries_1}
    \put(80,110){\huge }
    \put(-5,95){\textbf{(A)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A03/21-single-timeseries_33}
    \put(-5,95){\textbf{(B)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A03/21-single-timeseries_66}
    \put(-5,95){\textbf{(C)}}
  \end{overpic}
  \begin{overpic}[width=0.49\textwidth]{figures/results/A03/21-single-timeseries_100}
    \put(-5,95){\textbf{(D)}}
  \end{overpic}
\end{minipage}
\begin{minipage}{0.49\linewidth}	
\centering
{\Large Power law fits over inflow/outflow}\vspace{1em}\\
  \begin{overpic}[width=0.99\textwidth]{figures/results/A03/24-multipanel-pdf-inflow-outflow}
  	\put(-0,95){\textbf{(E)}}
  \end{overpic}
\end{minipage}
  ...
  \vskip1em
  {\LARGE Exponents of power law fits + avg. integer + mass}\vspace{1em}\\
  \begin{overpic}[width=0.32\textwidth]{figures/results/A03/24b-plot-pdf-inflow-outflow-exponent}
  	\put(-5,85){\textbf{(F)}}
  \end{overpic}
  \begin{overpic}[width=0.32\textwidth]{figures/results/A03/22-plot-avg-integer}
  	\put(-5,85){\textbf{(G)}}
  \end{overpic}
  \begin{overpic}[width=0.32\textwidth]{figures/results/A03/23-plot-total-mass}
  	\put(-5,85){\textbf{(H)}}
  \end{overpic}
  \caption{Key outputs: limit cases, power law fits and exponents, average integer and total mass.}
  \label{fig:wrap-up-15-18}
